...
pub fn create_context_menu() -> Menu {
    ...
    let capture = Submenu::new("Capture",
                              Menu::new().add_item(CustomMenuItem::new("capture_fullscreen".to_string(), "Fullscreen Capture").accelerator("CmdOrCtrl+F"))
                                  ...
                                  .add_native_item(MenuItem::Separator)
                                  .add_item(CustomMenuItem::new("capture_mouse_pointer".to_string(), "Toggle Capture Mouse Pointer").accelerator("Option+M"))
                                  .add_item(CustomMenuItem::new("copy_to_clipboard".to_string(), "Toggle Copy To Clipboard").accelerator("Option+C"))
                                  .add_item(CustomMenuItem::new("open".to_string(), "Toggle Edit After Capture").accelerator("Option+E")));
    let record = Submenu::new("Record",
                              Menu::new().add_item(CustomMenuItem::new("record_fullscreen".to_string(), "Fullscreen Record").accelerator("CmdOrCtrl+Option+F"))
                                  ...
                                  .add_native_item(MenuItem::Separator)
                                  .add_item(CustomMenuItem::new("capture_mouse_pointer".to_string(), "Toggle Record Mouse Pointer").accelerator("Option+M"))
                                  .add_item(CustomMenuItem::new("open".to_string(), "Toggle Open After Record").accelerator("Option+O")));
